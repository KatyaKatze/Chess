public class ChessBoard {
    ...
    String nowPlayer;       //поле класса

    public ChessBoard(String nowPlayer){
        this.nowPlayer = nowPlayer;     //конструктор класса
    }

    public String nowPlayerColor() {
        return this.nowPlayer;      //вспомогательный метод
    }

    public boolean checkPos(int pos) {
        return pos >= 0 && pos <= 7;    //метод для проверки не выходит ли позиция за пределы доски (доска от 1 до 8)
    }
